...
public class QdrantMemoryCollectionUpdateServiceTests(ITestOutputHelper output, QdrantMemoryFixture fixture)
{
    [Fact]
    public async Task ItCanCheckIfCollectionExistsForExistingCollectionAsync()
    {
        // Arrange.
        var sut = new QdrantMemoryCollectionUpdateService(fixture.QdrantClient);
