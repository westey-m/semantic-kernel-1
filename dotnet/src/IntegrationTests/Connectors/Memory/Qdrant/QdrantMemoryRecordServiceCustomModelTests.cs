...
using static SemanticKernel.IntegrationTests.Connectors.Memory.Qdrant.QdrantMemoryFixture;

namespace SemanticKernel.IntegrationTests.Connectors.Memory.Qdrant;

/// <summary>
/// Contains tests for the <see cref="QdrantMemoryRecordService{TDataModel}"/> class using a custom data model.
/// </summary>
...
public sealed class QdrantMemoryRecordServiceCustomModelTests(ITestOutputHelper output, QdrantMemoryFixture fixture)
{
    [Fact]
