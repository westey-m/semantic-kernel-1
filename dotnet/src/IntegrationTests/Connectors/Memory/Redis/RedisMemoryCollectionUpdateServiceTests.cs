...
public class RedisMemoryCollectionUpdateServiceTests(ITestOutputHelper output, RedisMemoryFixture fixture)
{
    [Fact]
    public async Task ItCanCheckIfCollectionExistsForExistingCollectionAsync()
    {
        // Arrange.
        var sut = new RedisMemoryCollectionUpdateService(fixture.Database);
