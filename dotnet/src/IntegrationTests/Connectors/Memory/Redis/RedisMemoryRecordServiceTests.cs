...
using static SemanticKernel.IntegrationTests.Connectors.Memory.Redis.RedisMemoryFixture;

namespace SemanticKernel.IntegrationTests.Connectors.Memory.Redis;

/// <summary>
/// Contains tests for the <see cref="RedisMemoryRecordService{TDataModel}"/> class.
/// </summary>
/// <param name="output">Used for logging.</param>
/// <param name="fixture">Redis setup and teardown.</param>
[Collection("RedisMemoryCollection")]
public sealed class RedisMemoryRecordServiceTests(ITestOutputHelper output, RedisMemoryFixture fixture)
{
    [Fact]
