...
public class AzureAISearchVectorCollectionNonSchemaTests(ITestOutputHelper output, AzureAISearchVectorStoreFixture fixture) : IClassFixture<AzureAISearchVectorStoreFixture>
{
    ...
    {
        // Arrange
        var sut = new AzureAISearchVectorCollectionNonSchema(fixture.SearchIndexClient);
