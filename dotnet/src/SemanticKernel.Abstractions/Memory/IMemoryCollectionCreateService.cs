...
/// <summary>
/// Interface used to create new colletions in a memory store.
/// </summary>
[Experimental("SKEXP0001")]
public interface IMemoryCollectionCreateService
{
    /// <summary>
    /// Creates a new collection with the given name in the memory store.
    /// </summary>
