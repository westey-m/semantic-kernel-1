...
{
    internal VectorSearchQuery(object? vector, object? queryData, object? searchOptions)
    {
    ...
    // Vector search.
    public static VectorSearchVectorQuery<TVectorElement> CreateQuery<TVectorElement>(ReadOnlyMemory<TVectorElement> vector, VectorSearchOptions? options = default) => new(vector, options);

    // Typed text search.
    public static VectorSearchTextEmbeddingQuery<TVectorElement> CreateQuery<TVectorElement>(string text, VectorSearchOptions? options = default) => new(text, options);
    ...
    // We probably don't need to support this until we have a good server generated vector use case.
    public static VectorSearchQuery CreateHybridQuery(string text, HybridVectorSearchOptions? options = default) => new(null, text, options);
}
