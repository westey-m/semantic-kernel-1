...
public static class VectorSearchExtensions
{
    ...
    /// <summary>
    /// Search the vector store for records that match the given embedding and text using a hybrid search.
    /// </summary>
    /// <typeparam name="TRecord">The type of record stored in the database and returned by the search.</typeparam>
    /// <typeparam name="TVector">The type of the vector.</typeparam>
    /// <param name="search">The search interface that this method extends.</param>
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>The records found by the vector search, including their result scores.</returns>
    public static IAsyncEnumerable<VectorSearchResult<TRecord>> HybridVectorizedTextSearchAsync<TRecord, TVector>(
        this IVectorSearch<TRecord> search,
        TVector vector,
        string searchText,
        HybridVectorSearchOptions? options = default,
        CancellationToken cancellationToken = default)
        where TRecord : class
    {
        return search.SearchAsync(new HybridTextVectorizedSearchQuery<TVector>(vector, searchText, options), cancellationToken);
    }

    /// <summary>
    /// Search the vector store for records that match the given text using a hybrid search. The text string will be vectorized downstream and used for the vector search.
    /// </summary>
    /// <typeparam name="TRecord">The type of record stored in the database and returned by the search.</typeparam>
    /// <param name="search">The search interface that this method extends.</param>
    ...
    /// <param name="cancellationToken">The <see cref="CancellationToken"/> to monitor for cancellation requests. The default is <see cref="CancellationToken.None"/>.</param>
    /// <returns>The records found by the vector search, including their result scores.</returns>
    public static IAsyncEnumerable<VectorSearchResult<TRecord>> HybridVectorizableTextSearchAsync<TRecord>(
        this IVectorSearch<TRecord> search,
        string searchText,
        HybridVectorSearchOptions? options = default,
        CancellationToken cancellationToken = default)
        where TRecord : class
    {
        return search.SearchAsync(new HybridVectorizableTextSearchQuery(searchText, options), cancellationToken);
    }
}
