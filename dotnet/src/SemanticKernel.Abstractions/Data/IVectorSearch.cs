    ...
    where TRecord : class
{
    ...
    IAsyncEnumerable<VectorSearchResult<TRecord>> SearchAsync<TVectorElement>(VectorSearchQuery<TVectorElement> vectorQuery, VectorSearchOptions? options = default, CancellationToken cancellationToken = default);
}
