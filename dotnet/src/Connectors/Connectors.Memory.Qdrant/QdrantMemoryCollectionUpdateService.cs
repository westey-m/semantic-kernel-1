...
public sealed class QdrantMemoryCollectionUpdateService : IMemoryCollectionUpdateService
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QdrantMemoryCollectionUpdateService"/> class.
    /// </summary>
    /// <param name="qdrantClient">Qdrant client that can be used to manage the collections and points in a Qdrant store.</param>
    public QdrantMemoryCollectionUpdateService(QdrantClient qdrantClient)
    {
