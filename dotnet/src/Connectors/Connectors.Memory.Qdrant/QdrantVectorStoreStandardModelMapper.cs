...
/// </summary>
public sealed class QdrantVectorStoreStandardModelMapper : IVectorStoreRecordMapper<VectorDBRecord, PointStruct>
{
    /// <summary>Optional options to use when doing the model conversion.</summary>
    private readonly QdrantVectorStoreStandardModelMapperOptions _options;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QdrantVectorStoreStandardModelMapper"/> class.
    /// </summary>
    /// <param name="options">Optional options to use when doing the model conversion.</param>
    public QdrantVectorStoreStandardModelMapper(QdrantVectorStoreStandardModelMapperOptions options)
    {
        this._options = options ?? new QdrantVectorStoreStandardModelMapperOptions();
