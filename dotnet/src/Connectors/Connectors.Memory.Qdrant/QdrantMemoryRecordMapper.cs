...
public class QdrantMemoryRecordMapper : IMemoryRecordMapper<VectorDBRecord, PointStruct>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QdrantMemoryRecordMapper"/> class.
    /// </summary>
    /// <param name="options">Optional options to use when doing the model conversion.</param>
    public QdrantMemoryRecordMapper(QdrantMemoryRecordMapperOptions options)
    {
        this._options = options ?? new QdrantMemoryRecordMapperOptions();
