...
internal sealed class QdrantMemoryRecordJsonMapper<TDataModel> : IMemoryRecordMapper<TDataModel, PointStruct>
    where TDataModel : class
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="QdrantMemoryRecordJsonMapper{TDataModel}"/> class.
    /// </summary>
    /// <param name="options">Optional options to use when doing the model conversion.</param>
    public QdrantMemoryRecordJsonMapper(QdrantMemoryRecordJsonMapperOptions? options)
    {
