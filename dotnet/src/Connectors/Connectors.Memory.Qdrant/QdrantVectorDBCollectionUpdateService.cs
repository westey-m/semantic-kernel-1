...
/// </summary>
public class QdrantVectorDBCollectionUpdateService : IVectorDBCollectionUpdateService
{
    /// <summary>Qdrant client that can be used to manage the collections and points in a Qdrant store.</summary>
    private readonly QdrantClient _qdrantClient;

    /// <summary>
    /// Initializes a new instance of the <see cref="QdrantVectorDBCollectionUpdateService"/> class.
    /// </summary>
    /// <param name="qdrantClient">Qdrant client that can be used to manage the collections and points in a Qdrant store.</param>
    public QdrantVectorDBCollectionUpdateService(QdrantClient qdrantClient)
    {
