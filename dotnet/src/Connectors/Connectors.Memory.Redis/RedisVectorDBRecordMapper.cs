    ...
    where TConsumerDataModel : class
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="RedisVectorDBRecordMapper{TConsumerDataModel}"/> class.
    /// </summary>
    /// <param name="keyFieldJsonPropertyName">The name of the key field on the model when serialized to json.</param>
    public RedisVectorDBRecordMapper(string keyFieldJsonPropertyName)
    {
