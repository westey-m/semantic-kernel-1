...
/// </summary>
public class RedisVectorDBCollectionUpdateService : IVectorDBCollectionUpdateService
{
    /// <summary>The redis database to read/write indices from.</summary>
    private readonly IDatabase _database;

    /// <summary>
    /// Initializes a new instance of the <see cref="RedisVectorDBCollectionUpdateService"/> class.
    /// </summary>
    /// <param name="database">The redis database to read/write indices from.</param>
    public RedisVectorDBCollectionUpdateService(IDatabase database)
    {
