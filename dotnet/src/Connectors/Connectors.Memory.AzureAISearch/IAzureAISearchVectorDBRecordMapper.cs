...
/// <summary>
/// Interface for mapping between a azure ai search record, in <see cref="JsonObject"/> format, and the consumer data model.
/// </summary>
...
public interface IAzureAISearchVectorDBRecordMapper<TConsumerDataModel, TStorageModel>
