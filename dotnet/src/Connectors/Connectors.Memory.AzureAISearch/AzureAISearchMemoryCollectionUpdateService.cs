...
public class AzureAISearchMemoryCollectionUpdateService : IMemoryCollectionUpdateService
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AzureAISearchMemoryCollectionUpdateService"/> class.
    /// </summary>
    ...
    public AzureAISearchMemoryCollectionUpdateService(SearchIndexClient searchIndexClient)
    {
