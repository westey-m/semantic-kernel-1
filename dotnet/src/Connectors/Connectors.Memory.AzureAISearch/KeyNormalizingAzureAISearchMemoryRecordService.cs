...
/// <summary>
/// Decorator class for <see cref="IMemoryRecordService{TKey, TDataModel}"/> that normalizes the index names and encodes and decodes the record keys so that any values
...
/// </remarks>
public sealed class KeyNormalizingAzureAISearchMemoryRecordService<TDataModel> : IMemoryRecordService<string, TDataModel>
    where TDataModel : class
{
    /// <summary>The vector store instance that is being decorated.</summary>
    private readonly IMemoryRecordService<string, TDataModel> _vectorStore;
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="KeyNormalizingAzureAISearchMemoryRecordService{TDataModel}"/> class.
    /// </summary>
    ...
    public KeyNormalizingAzureAISearchMemoryRecordService(
        IMemoryRecordService<string, TDataModel> vectorStore,
